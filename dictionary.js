...
function russifyOrigin(str) {
	const dictionaryOrigin = {
		...
		origin_progenitor_hive: 'Улей-прародитель',
		origin_subterranean: 'Дети подземелья',
		origin_star_slingshot: 'Звездная катапульта',
		origin_shroudwalker_apprentice: 'Учителя Покрова',
		origin_imperial_vassal: 'Имперский феод',
		origin_overtuned: 'Разогнанные',
		origin_toxic_knights: 'Рыцари Токсичного бога',
		origin_payback: 'Расплата',
		origin_broken_shackles: 'Сброшенные оковы',
		origin_fear_of_the_dark: 'Страх темноты',
		origin_legendary_leader: 'Под единой властью',
		origin_fruitful: 'Плодотворное сотрудничество',
		origin_riftworld: 'Приразломный мир'
	};
